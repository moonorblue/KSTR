...
for p in pro: 
    ...
    log = open('/home/moonorblue/exp/V7_6/expV7_fb_parallel_skyline_total_user_checkincount_log_'+str(p),'a')
    ...
    for row in rows:
        ...
        with open('/home/moonorblue/exp/V7_6/fb/allScore/expV7_'+str(p)+'.csv', 'a') as w:
        ...
        with open('/home/moonorblue/exp/V7_6/fb/PATS/expV7_'+str(p)+'.csv', 'a') as w:
        ...
        if progressCount in StopNumbers:
            shutil.copyfile('/home/moonorblue/exp/V7_6/fb/allScore/expV7_'+str(p)+'.csv', '/home/moonorblue/exp/V7_6/fb/allScore/expV7_'+str(progressCount)+'_'+str(p)+'.csv')
            shutil.copyfile('/home/moonorblue/exp/V7_6/fb/avgScore/expV7_'+str(p)+'.csv', '/home/moonorblue/exp/V7_6/fb/avgScore/expV7_'+str(progressCount)+'_'+str(p)+'.csv')
            shutil.copyfile('/home/moonorblue/exp/V7_6/fb/PATS/expV7_'+str(p)+'.csv', '/home/moonorblue/exp/V7_6/fb/PATS/expV7_'+str(progressCount)+'_'+str(p)+'.csv')
            shutil.copyfile('/home/moonorblue/exp/V7_6/fb/timescore/expV7_'+str(p)+'.csv', '/home/moonorblue/exp/V7_6/fb/timescore/expV7_'+str(progressCount)+'_'+str(p)+'.csv')
            shutil.copyfile('/home/moonorblue/exp/V7_6/fb/socialInf/expV7_'+str(p)+'.csv', '/home/moonorblue/exp/V7_6/fb/socialInf/expV7_'+str(progressCount)+'_'+str(p)+'.csv')
            shutil.copyfile('/home/moonorblue/exp/V7_6/fb/skyline/expV7_'+str(p)+'.csv', '/home/moonorblue/exp/V7_6/fb/skyline/expV7_'+str(progressCount)+'_'+str(p)+'.csv')
            shutil.copyfile('/home/moonorblue/exp/V7_6/fb/expV7_time_'+str(p)+'.csv', '/home/moonorblue/exp/V7_6/fb/expV7_time_'+str(progressCount)+'_'+str(p)+'.csv')
