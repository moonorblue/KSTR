...
query = "SELECT a.poi,a.region_minlong,a.region_minlat,a.region_maxlong,a.region_maxlat,a.uid,a.rid,a.geom  FROM ca_route a WHERE a.rid = '104878' ;" 
# query = "SELECT a.poi,a.region_minlong,a.region_minlat,a.region_maxlong,a.region_maxlat,a.uid,a.rid,a.geom FROM ca_route a,ca_checkincount b WHERE b.uid = a.uid AND st_area(a.geom) != 0 AND a.rid ='104878' ORDER BY b.checkincount,a.rid  ;"
...
for p in pro: 
    ...
    for row in rows:     
        for testtime in xrange(10):      
            ...
            for rc in routescount:
                ...
                # print 'reconstructionTime ',reconstructionTime 
                ...
                # print 'reconstruction + result_time',reconstructionTime+result_time
    ...
    for i in sorted(timeDict.items(), key=operator.itemgetter(0)):
        print i[1]
    #print 'sequential process' process time of [100,200,400,800,1500,3000,5000,8000,12000,15000,18000,21000,24000,27000,30000] covered routes
print 'Finish!'
