...
FBCategoryPOICountDict = json.load(open('/home/moonorblue/exp/materials/CA_CategoryPOICount'))
FBPOICountDict = json.load(open('/home/moonorblue/exp/materials/CA_POICount'))
FBUserPOICountDict = json.load(open('/home/moonorblue/exp/materials/CA_userPOICheckinCount'))
FB_ATDict = json.load(open('/home/moonorblue/exp/materials/CA_AT'))
...
for p in pro: 
    ...
    for row in rows:
        ...
        with open('/home/moonorblue/exp/V8/ca/allScore/expV8_'+str(p)+'.csv', 'a') as w:
        ...
        with open('/home/moonorblue/exp/V8/ca/avgScore/expV8_'+str(p)+'.csv', 'a') as w:
        ...
        with open('/home/moonorblue/exp/V8/ca/PATS/expV8_'+str(p)+'.csv', 'a') as w:
        ...
        with open('/home/moonorblue/exp/V8/ca/timescore/expV8_'+str(p)+'.csv', 'a') as w:
        ...
        with open('/home/moonorblue/exp/V8/ca/socialInf/expV8_'+str(p)+'.csv', 'a') as w:
        ...
        with open('/home/moonorblue/exp/V8/ca/skyline/expV8_'+str(p)+'.csv', 'a') as w:
        ...
        with open('/home/moonorblue/exp/V8/ca/KM/expV8_'+str(p)+'.csv', 'a') as w:
            ...
            w.close()
        #time
        with open('/home/moonorblue/exp/V8/ca/expV8_time_'+str(p)+'.csv', 'a') as y:
        ...
        if progressCount in StopNumbers:
            shutil.copyfile('/home/moonorblue/exp/V8/ca/allScore/expV8_'+str(p)+'.csv', '/home/moonorblue/exp/V8/ca/allScore/expV8_'+str(progressCount)+'_'+str(p)+'.csv')
            shutil.copyfile('/home/moonorblue/exp/V8/ca/avgScore/expV8_'+str(p)+'.csv', '/home/moonorblue/exp/V8/ca/avgScore/expV8_'+str(progressCount)+'_'+str(p)+'.csv')
            shutil.copyfile('/home/moonorblue/exp/V8/ca/PATS/expV8_'+str(p)+'.csv', '/home/moonorblue/exp/V8/ca/PATS/expV8_'+str(progressCount)+'_'+str(p)+'.csv')
            shutil.copyfile('/home/moonorblue/exp/V8/ca/timescore/expV8_'+str(p)+'.csv', '/home/moonorblue/exp/V8/ca/timescore/expV8_'+str(progressCount)+'_'+str(p)+'.csv')
            shutil.copyfile('/home/moonorblue/exp/V8/ca/socialInf/expV8_'+str(p)+'.csv', '/home/moonorblue/exp/V8/ca/socialInf/expV8_'+str(progressCount)+'_'+str(p)+'.csv')
            shutil.copyfile('/home/moonorblue/exp/V8/ca/skyline/expV8_'+str(p)+'.csv', '/home/moonorblue/exp/V8/ca/skyline/expV8_'+str(progressCount)+'_'+str(p)+'.csv')
            shutil.copyfile('/home/moonorblue/exp/V8/ca/KM/expV8_'+str(p)+'.csv', '/home/moonorblue/exp/V8/ca/KM/expV8_'+str(progressCount)+'_'+str(p)+'.csv')
            shutil.copyfile('/home/moonorblue/exp/V8/ca/expV8_time_'+str(p)+'.csv', '/home/moonorblue/exp/V8/ca/expV8_time_'+str(progressCount)+'_'+str(p)+'.csv')
